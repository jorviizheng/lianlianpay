...
exports.paraFilter = function(para){
    ...
    for (var key in para){
        ...
        //if(key == 'sign' || key == 'sec_id' || para[key] == ''){
            continue;
        }
        else{
            // console.log(key, ' : ', para[key]);
            para_filter[key] = para[key];
        }
    }
    // console.log('===========|||||||||||||||||');
    // console.log(para_filter);
    return para_filter;
}
...
exports.getHttpResponsePOST = function(url, cacert_url, para, input_charset, callback){
    ...
    //console.log("url: "+parsed_url.host+parsed_url.path+para_str);
    // console.log('33333');
    // console.log(options);
    ...
    //para_str = decodeURIComponent(para_str);
    //para_str = encodeURIComponent(para_str)
